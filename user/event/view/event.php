...
<section class="content blog-page">
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="http://classlink.com/user/event/controller/event_data.php" method="post" id="postdata" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                    ...
                    <div class="card">
                        <div class="body">
                        <div class="form-group">
                        <textarea name="discription" class="form-control" placeholder="Event Discription . . ."></textarea>
                        </div>
                            <div>
                            <input type="file"  name="picture" class="dropify">
                            </div>
                            <button type="button" class="btn btn-info waves-effect m-t-20" onClick="post();">SET EVENTS</button>
                        </div>
                    </div>
                            <!-------script ------->
                            <script>
