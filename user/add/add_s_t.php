        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>ADD TEACHER OR ADD STUDENT</h2>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                        <a href="http://classlink.com/user/add/view/add_teacher.php" class="btn btn-primary">ADD TEACHER</a>
                        <a href="http://classlink.com/user/add/view/add_student.php" class="btn btn-primary">ADD STUDENT</a>
                        </div>
