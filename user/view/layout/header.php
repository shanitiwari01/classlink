...
<!-- Favicon-->
<link rel="stylesheet" href="http://classlink.com/user/assets/css/bootstrap.min.css">
<!-- Custom Css -->
<link rel="stylesheet" href="http://classlink.com/user/assets/css/style.min.css">
</head>
...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    <a class="image" href="profile.html"><img src="http://classlink.com/user/assets/images/profile_av.jpg" alt="User"></a>
                    <div class="detail">
                        <h4>Michael</h4>
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-grid"></i><span>Tables</span></a>
                <ul class="ml-menu">
                    <li class="active"><a href="normal-tables.html">Normal Tables</a></li>
