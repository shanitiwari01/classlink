...
<section class="content blog-page">
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="http://classlink.com/user/blog_post/controller/post_data.php" method="post" id="postdata" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter Blog title" name="blog_title" />
                            </div>
