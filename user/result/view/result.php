...
<section class="content blog-page">
    <div class="body_scroll">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form action="http://classlink.com/user/result/controller/result_data.php" method="post" id="postdata" enctype="multipart/form-data">
                    <div class="card">
                        <div class="body">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Enter title of result..." name="title" />
                            </div>
                    ...
                    <div class="card">
                        <div class="body">
                        <div class="form-group">
                        <textarea name="discription" class="form-control" placeholder="Result Discription . . ."></textarea>
                        </div>
                            <div>
                            <input type="file"  name="picture"  class="dropify">
                            </div>
                            <button type="button" class="btn btn-info waves-effect m-t-20" onClick="post();">SEND RESULT</button>
                        </div>
                    </div>
                            <!-------script ------->
                            <script>
